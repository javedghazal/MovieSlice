...
public class TopFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        recycler_top = (RecyclerView) getView().findViewById(R.id.recycler_Top);
        gridLayoutManager = new GridLayoutManager(getContext(), 1);
        recycler_top.setLayoutManager(gridLayoutManager);
        ApiInterface apiService =
                ApiClient.getClient().create(ApiInterface.class);
        Call<MoviesResponse> call = apiService.getTopRatedMovies("top_rated", getResources().getString(R.string.api_key));
        call.enqueue(new Callback<MoviesResponse>() {
            ...
            public void onResponse(Call<MoviesResponse> call, Response<MoviesResponse> response) {
                ...
                recycler_top.setAdapter(moviesAdapter);
            }
