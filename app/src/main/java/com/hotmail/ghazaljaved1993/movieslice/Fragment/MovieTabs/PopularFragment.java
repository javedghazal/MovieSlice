...
public class PopularFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recycler_pop = (RecyclerView) getView().findViewById(R.id.recycler_Pop);
        gridLayoutManager = new GridLayoutManager(getContext(), 1);
        recycler_pop.setLayoutManager(gridLayoutManager);
        ApiInterface apiService =
                ApiClient.getClient().create(ApiInterface.class);
        Call<MoviesResponse> call = apiService.getTopRatedMovies("popular",getResources().getString(R.string.api_key));
        call.enqueue(new Callback<MoviesResponse>() {
            ...
            public void onResponse(Call<MoviesResponse> call, Response<MoviesResponse> response) {
                ...
                recycler_pop.setAdapter(moviesAdapter);
            }
